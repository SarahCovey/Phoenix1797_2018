...
public class RightRamp extends Subsystem {
	...
	public RightRamp() {
		liftPiston = new DoubleSolenoid(RobotMap.getPort("right_ramp_1"), RobotMap.getPort("right_ramp_2"));
	}
	...
	public void lift() {
		System.out.println("Lifting right ramp");
	...
	public void retract() {
		System.out.println("Retracting right ramp");
